...
export const BREEDER_CONTACT_EMAIL = 'pawsomepomskies@gmail.com';
...
export const SOCIAL_LINKS = {
  ...
  tiktok: 'https://www.tiktok.com/@Paw-SomePomskies',
  youtube: 'https://www.youtube.com/@Paw-SomePomskies',
...
export const INITIAL_GUARDIAN_DOGS: any[] = [
  {
    id: 'g1',
    name: 'Luna',
    gender: 'Female',
    ...
    description: 'Luna is a sweet, gentle soul looking for a loving guardian home. She loves cuddles and is great with kids.',
    breed: 'F2 Pomsky',
    status: 'Available'
  }
];
